...
import { AnnonceVoteIncrementPublisher } from '../events/publisher/annonceVote-increment-publisher';
import { Voting } from '../models/voting';

const router = express.Router();

router.post(
  '/api/vote/annonce/:annonceId/increment',
  requireAuth,
  [
    body('annonceId')
      .not()
  ...
  async (req: Request, res: Response) => {
    ...
    new AnnonceVoteIncrementPublisher(natsWrapper.client).publish({
      id: voting.id,
...
export { router as voteAnnonceIncrement };
